...
$route['participants/(:any)/(:any)/(:any)'] = 'gateway/get_participants/$1/$2/$3';
$route['manage_participant'] = 'gateway/manage_participant';
$route['add_participant'] = 'gateway/add_participant';
$route['manage_transaction/(:any)/(:any)'] = 'gateway/manage_transaction/$1/$2';
...
$route['topup_wallet/(:any)'] = 'gateway/topup_wallet/$1';
$route['get_app/(:any)'] = 'gateway/get_app/$1';
$route['update_app/(:any)'] = 'gateway/update_app/$1';
$route['delete_app/(:any)'] = 'gateway/delete_app/$1';
$route['user/(:any)'] = 'gateway/load_page/transaction/user/$1';
$route['manage_user/(:any)'] = 'gateway/manage_user/$1';
$route['validate_participant'] = 'gateway/validate_participant';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;